      ...
      <div>
        ...
        <div className="wrap">
          <div className="classInfo">
            <p>
              {' '}
              <b>Date:</b> {classDay.date}
            </p>
            <p>
              <b>Time:</b>: {classDay.time}
            </p>
            <p>
              <b>Location:</b>: {classDay.location}
            </p>
            <p>
              <b>Activities:</b>: {classDay.activities}
            </p>
            <p>
              <b>Forecast:</b>: {classDay.forecast}
            </p>

            {classDay.userName && props.user.name === classDay.userName && (
